...
# instalar paquetes
sudo xbps-install -Sy 7zip 7zip-unrar barrier barrier bpytop cnijfilter2 cups curl epson-inkjet-printer-escpr exfatprogs fastfetch filezilla flameshot galculator gparted gwenview hunspell-es iscan kolourpaint leafpad libreoffice libreoffice-i18n-es lxde mpv nano okular qbittorrent rsync smplayer wget
