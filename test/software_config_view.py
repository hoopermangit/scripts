...
CATEGORIES = {
    "System & Hardware": [
        ("meta:printer", "Printer-Support (CUPS)"),
    ...
    "Office": [
        ...
        ("xbps:libreoffice-i18n-es", "LibreOffice (ES)"),
        ("xbps:papers", "Papers (PDF)"),
        ("xbps:gnome-calendar", "GNOME Calender"),
        ("xbps:gnome-calculator", "Calculadora"),
    ],
    "Internet": [
        ("xbps:chromium", "Chromium"),
    ],
    "Multimedia": [
        ("xbps:smplayer", "SM Media Player"),
        ("xbps:mpv", "MPV Player"),
    ],
    "Grafik": [
        ("xbps:gimp", "GIMP"),
...
class SoftwareConfigView(Gtk.Box):
    def __init__(self):
        ...
        self.append(Gtk.Label(label="Seleccione software adicional (se requiere Internet):", xalign=0))
